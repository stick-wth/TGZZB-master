package com.tgzzb.cdc.utils.PicturePelector;
...
public class GridImageAdapter extends
    ...
    public GridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
        ...
        Log.d("GridImageAdapter", "GridImageAdapter~~~");
    }
    ...
    public int getItemCount() {
        Log.d("GridImageAdapter", "list.size()="+list.size());
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.picselector_gv_item,
                viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        Log.d("GridImageAdapter", "onBindViewHolder: getItemViewType="+getItemViewType(position));
        //少于8张，显示继续添加的图标
